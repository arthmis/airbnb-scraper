...
start_date_xpath = '//td[@aria-label="Choose {}, {} {}, {} as your {} date. It\'s available."]'.format("Tuesday", "July", 23, 2019, "start")
...
end_date_xpath = '//td[@aria-label="Choose {}, {} {}, {} as your {} date. It\'s available."]'.format("Friday", "July", 26, 2019, "end")
...
try:
    ...
    # entire_home_checkbox = wait.until(expected.visibility_of(browser.find_element_by_id(entire_home_checkbox_id)), "couldn't find entire home checkbox")
    # entire_home_checkbox_xpath = '//input[@id=DynamicFilterCheckboxItem-Type_of_place-room_types-Entire_home/apt and @class="_iddnf3"]'
    entire_home_checkbox_xpath = '//input[@name="Type_of_place-room_types-Entire_home/apt" and @class="_iddnf3" and @type="checkbox"]'
    entire_home_checkbox = wait.until(expected.visibility_of(browser.find_element_by_xpath(entire_home_checkbox_xpath)), "couldn't find entire home checkbox")
...
# actions.move_to_element(price_filter_min)
# actions.click(price_filter_min)
...
# html = open("airbnb-scrape/San Francisco-Stays-Airbnb.html")
